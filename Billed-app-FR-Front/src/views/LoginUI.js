            ...
            <div class="card">
              <div class="card-body">
                <form class="form-signin" data-testid="form-employee">
                  ...
                  <input type="email" data-testid="employee-email-input" class="form-control" placeholder="johndoe@email.com" required autofocus value="employee@test.tld">
                  <label for="inputPassword">Mot de passe</label>
                  <input type="password" data-testid="employee-password-input" class="form-control" placeholder="******" required value="employee">
            ...
            <div class="card">
              <div class="card-body">
                <form class="form-signin" data-testid="form-admin">
                  ...
                  <label for="inputEmail">Votre email</label>
                  <input type="email" data-testid="admin-email-input" class="form-control" placeholder="johndoe@email.com" required autofocus value="admin@test.tld">
                  <label for="inputPassword">Mot de passe</label>
                  <input type="password" data-testid="admin-password-input" class="form-control" placeholder="******" required value="admin">
